...
@icon-font-path: "//at.alicdn.com/t/font_881652_s3dlxhnu6h";
...
@timeline-item-title-color: #000000;
...
@timeline-item-process-background: #FF6A00;
...
@checkbox-hovered-border-color: #FF6A00;
...
@checkbox-checked-bg-color: #FF6A00;

@checkbox-hovered-bg-color: #FFF0E6;

@checkbox-checked-hovered-bg-color: #E35300;
...
@tree-node-normal-color: #000000;

@tree-node-normal-background: #FFFFFF;

@tree-node-title-border-radius: 5px;
...
@tree-switch-corner: 5px;

@tree-line-color: #C4C6CF;

@tree-line-style: solid;

@tree-node-hover-color: #000000;

@tree-node-hover-bg-color: #F2F3F7;

@tree-switch-hover-arrow-color: #000000;

@tree-switch-hover-icon-color: #000000;

@tree-switch-hover-bg-color: #F2F3F7;

@tree-switch-hover-border-color: #A0A2AD;

@tree-node-selected-color: #000000;

@tree-node-selected-background: #FFF0E6;
...
@search-normal-corner: 30px;

@search-normal-primary-color: #FF6A00;

@search-normal-primary-hover-color: #FF6A00;
...
@search-normal-primary-btn-hover-bg-color: #E35300;
...
@search-normal-secondary-hover-color: #FF6A00;

@search-normal-secondary-shadow: none;

@search-normal-secondary-btn-bg-color: #FF6A00;

@search-normal-secondary-btn-text-color: #FFFFFF;

@search-normal-secondary-btn-hover-bg-color: #E35300;
...
@search-normal-normal-btn-hover-text-color: #000000;
...
@search-normal-dark-color: #FF6A00;

@search-normal-dark-hover-color: #FF6A00;
...
@search-normal-dark-btn-hover-bg-color: #E35300;
...
@rating-normal-overlay-color: #FF6A00;

@rating-normal-overlay-hover-color: #FF6A00;

@rating-grade-low-overlay-color: #999999;

@rating-grade-low-overlay-hover-color: #999999;

@rating-grade-high-overlay-color: #FF6A00;

@rating-grade-high-overlay-hover-color: #FF6A00;
...
@cascader-menu-border-radius: 5px;

@cascader-menu-icon-expand-color: #666666;

@cascader-menu-icon-hover-expand-color: #000000;

@cascader-menu-item-expanded-color: #000000;
...
@range-size-m-slider-shadow-moving: 2px 2px 6px 0px rgba(255, 106, 0, 0.3);

@range-normal-unselected-color: #C4C6CF;

@range-normal-selected-color: #FF6A00;

@range-normal-slider-bg-color: #FFFFFF;

@range-normal-mark-color: #999999;

@range-normal-mark-selected-color: #000000;

@range-normal-unselected-color-hover: #C4C6CF;

@range-normal-selected-color-hover: #FF6A00;

@range-normal-slider-bg-color-hover: #FFFFFF;

@range-size-m-slider-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);

@range-size-m-slider-shadow-hover: 4px 4px 10px 0px rgba(0, 0, 0, 0.1);

@range-normal-mark-color-hover: #999999;

@range-normal-mark-selected-color-hover: #000000;
...
@menu-btn-pure-text-secondary-icon-color: #FF6A00;

@menu-btn-text-text-normal-icon-color: #000000;

@menu-btn-text-text-primary-icon-color: #5584FF;

@menu-btn-ghost-light-icon-color: #000000;
...
@switch-size-m-radius-container: 30px;

@switch-size-m-trigger: 24px;

@switch-size-m-radius-trigger: 30px;

@switch-size-s-width: 44px;

@switch-size-s-radius-container: 30px;

@switch-size-s-trigger: 20px;

@switch-size-s-radius-trigger: 30px;
...
@switch-normal-on-bg-color: #FF6A00;

@switch-hover-on-bg-color: #E35300;
...
@switch-on-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
@switch-off-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
@card-title-bullet-color: #FF6A00;
...
@upload-text-list-name-font-color: #000000;

@upload-text-list-name-font-color-hover: #FF6A00;

@upload-text-list-size-font-color: #999999;

@upload-text-list-size-font-color-hover: #FF6A00;
...
@upload-image-list-item-border-color-hover: #FF6A00;
...
@upload-card-hover-border-color: #FF6A00;

@upload-card-icon-color: #FF6A00;

@upload-card-font-color: #666666;

@upload-card-hover-font-color: #FF6A00;
...
@upload-drag-zone-over-border-color: #FF6A00;

@upload-drag-zone-corner: 5px;
...
@menu-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
@menu-color-selected: #000000;

@menu-icon-selected-color: #FF6A00;

@menu-background-hover: #F2F3F7;

@menu-color-hover: #000000;

@menu-arrow-color-hover: #000000;

@menu-icon-selected-hover-color: #FF6A00;
...
@btn-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);

@btn-shadow-hover: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
@btn-pure-normal-color: #000000;

@btn-pure-normal-color-hover: #000000;
...
@btn-pure-secondary-color: #FF6A00;

@btn-pure-secondary-color-hover: #FFFFFF;

@btn-pure-secondary-bg: #FFFFFF;

@btn-pure-secondary-bg-hover: #E35300;

@btn-pure-secondary-border-color: #FF6A00;

@btn-pure-secondary-border-color-hover: #E35300;
...
@btn-pure-primary-bg: #FF6A00;

@btn-pure-primary-bg-hover: #E35300;
...
@btn-ghost-light-color: #000000;

@btn-ghost-light-border-color: #000000;
...
@btn-ghost-light-border-color-hover: #000000;
...
@btn-text-primary-color-hover: #E35300;

@btn-text-disabled-color: #CCCCCC;

@btn-text-loading-color: #000000;

@btn-text-secondary-color: #666666;

@btn-text-secondary-color-hover: #FF6A00;

@btn-text-normal-color: #000000;

@btn-text-normal-color-hover: #FF6A00;
...
@table-sort-color: #000000;

@table-group-th-bg: #EBECF0;

@table-group-th-color: #000000;
...
@table-group-footer-color: #000000;
...
@table-row-selected-color: #000000;

@table-sort-color-current: #FF6A00;
...
@tag-corner-radius: 5px;

@tag-checkable-corner-radius: 5px;
...
@tag-closable-bordered-text-color-hover: #000000;
...
@tag-closable-bordered-tail-color-hover: #000000;
...
@tag-secondary-text-color: #FF6A00;

@tag-normal-text-color-hover: #FF6A00;

@tag-fill-text-color-hover: #000000;

@tag-fill-tail-color-hover: #000000;

@tag-primary-text-color-hover: #FFFFFF;

@tag-primary-tail-color-hover: #FFFFFF;

@tag-bordered-text-color-hover: #000000;

@tag-bordered-tail-color-hover: #000000;
...
@tag-secondary-text-color-hover: #E35300;

@tag-bordered-border-color: #C4C6CF;

@tag-secondary-border-color: #FF6A00;

@tag-checkable-normal-bg-selected: #FF6A00;

@tag-checkable-secondary-bg-selected: #FF6A00;

@tag-bordered-border-color-hover: #A0A2AD;

@tag-secondary-border-color-hover: #E35300;

@tag-checkable-normal-bg-selected-hover: #E35300;

@tag-checkable-secondary-bg-selected-hover: #E35300;

@tag-fill-bg-color: #EBECF0;

@tag-primary-background-color: #FF6A00;
...
@tag-primary-bg-color-hover: #E35300;
...
@tag-checkable-fill-text-color-hover: #000000;

@tag-checkable-fill-bg-color-hover: #E2E4E8;

@tag-checkable-fill-tail-color: #666666;

@tag-checkable-fill-tail-color-hover: #000000;
...
@tag-checkable-normal-text-color-hover: #000000;
...
@tag-checkable-primary-bg-color: #FF6A00;

@tag-checkable-primary-text-color-hover: #FFFFFF;

@tag-checkable-primary-bg-color-hover: #E35300;
...
@tag-primary-bg-color-disabled: #FFF0E6;
...
@badge-size-custom-border-radius: 5px;
...
@balloon-normal-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);

@balloon-normal-color: #000000;

@balloon-normal-color-close: #999999;

@balloon-normal-color-close-hover: #666666;

@balloon-primary-color-bg: #FF6A00;

@balloon-primary-color-border: #FF6A00;

@balloon-primary-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);

@balloon-primary-color: #FFFFFF;

@balloon-primary-color-close: #FFFFFF;

@balloon-primary-color-close-hover: #000000;
...
@dialog-shadow: 0px 2px 6px 0px rgba(255, 106, 0, 0.3);
...
@dialog-close-color-hovered: #000000;
...
@message-border-radius-toast: 5px;

@message-border-style-toast: solid;

@message-shadow-toast: 0px 2px 6px 0px rgba(255, 106, 0, 0.3);
...
@message-success-color-title-inline: #000000;

@message-success-color-title-addon: #000000;

@message-success-color-title-toast: #000000;
...
@message-error-color-title-inline: #000000;

@message-error-color-title-addon: #000000;

@message-error-color-title-toast: #000000;
...
@message-warning-color-title-inline: #000000;

@message-warning-color-title-addon: #000000;

@message-warning-color-title-toast: #000000;
...
@message-notice-color-title-inline: #000000;

@message-notice-color-title-addon: #000000;

@message-notice-color-title-toast: #000000;
...
@message-help-color-title-inline: #000000;

@message-help-color-title-addon: #000000;

@message-help-color-title-toast: #000000;
...
@message-loading-color-title-inline: #000000;

@message-loading-color-title-addon: #000000;

@message-loading-color-title-toast: #000000;
...
@message-loading-color-icon-inline: #FF6A00;

@message-loading-color-icon-addon: #FF6A00;

@message-loading-color-icon-toast: #FF6A00;
...
@progress-line-radius-l: 30px;

@progress-line-radius-m: 30px;

@progress-line-radius-s: 30px;

@progress-line-font-color: #000000;

@progress-line-normal-color: #FF6A00;
...
@progress-circle-text-color: #000000;

@progress-circle-corner: round;

@progress-circle-normal-color: #FF6A00;
...
@pagination-current-color: #FF6A00;

@pagination-total-color: #000000;
...
@pagination-size-selector-filter-current-color: #FF6A00;

@pagination-item-current-color: #FFFFFF;

@pagination-arrow-hover-color: #000000;

@pagination-arrow-hover-color-noboder: #FF6A00;

@pagination-arrow-color: #666666;

@pagination-item-current-border-color: #FF6A00;

@pagination-item-current-bg: #FF6A00;

@pagination-item-current-hover-color: #FFFFFF;

@pagination-item-current-hover-border-color: #FF6A00;

@pagination-item-current-hover-bg: #FF6A00;
...
@transfer-panel-border-corner: 5px;

@transfer-panel-background-color: #FFFFFF;

@transfer-panel-header-text-color: #000000;

@transfer-panel-header-background-color: #F7F8FA;

@transfer-panel-search-icon-color: #999999;

@transfer-panel-footer-text-color: #000000;

@transfer-panel-footer-background-color: #FFFFFF;

@transfer-simple-panel-footer-text-color: #FF6A00;

@transfer-simple-panel-item-hover-text-color: #FF6A00;
...
@step-arrow-item-process-background: #FF6A00;

@step-arrow-item-title-process-color: #FFFFFF;

@step-arrow-item-finish-background: #FFF0E6;

@step-arrow-item-title-finish-color: #FF6A00;
...
@step-circle-item-tail-finish-color: #FF6A00;
...
@step-circle-item-title-process-color: #000000;
...
@step-circle-item-node-process-border-color: #FF6A00;

@step-circle-item-node-process-background: #FF6A00;

@step-circle-item-node-process-color: #FFFFFF;

@step-circle-item-node-process-percent-color: #FF6A00;

@step-circle-item-node-finish-border-color: #FF6A00;

@step-circle-item-node-finish-background: #FFFFFF;

@step-circle-item-node-finish-color: #FF6A00;
...
@step-dot-item-tail-finish-color: #FF6A00;

@step-dot-item-tail-disabled-color: #E6E7EB;

@step-dot-item-title-wait-color: #666666;

@step-dot-item-title-process-color: #000000;
...
@step-dot-item-node-process-border-color: #FF6A00;

@step-dot-item-node-process-background: #FF6A00;

@step-dot-item-node-process-color: #FF6A00;

@step-dot-item-node-finish-border-color: #FF6A00;

@step-dot-item-node-finish-background: #FFFFFF;

@step-dot-item-node-finish-color: #FF6A00;
...
@radio-hovered-bg-color: #FFF0E6;

@radio-checked-bg-color: #FF6A00;

@radio-disabled-bg-color: #F7F8FA;

@radio-checked-hovered-bg-color: #E35300;

@radio-border-color: #C4C6CF;

@radio-hovered-border-color: #FF6A00;

@radio-checked-border-color: #FF6A00;
...
@radio-normal-font-color: #000000;
...
@radio-button-corner-large: 30px;

@radio-button-corner-medium: 5px;

@radio-button-corner-small: 5px;
...
@radio-button-border-color-checked: #FF6A00;

@radio-button-border-color-disabled: #E6E7EB;

@radio-button-border-color-checked-disabled: #E6E7EB;

@radio-button-font-color: #000000;

@radio-button-font-color-hovered: #000000;

@radio-button-font-color-checked: #FF6A00;
...
@slick-dots-background-color-selected: #FF6A00;
...
@slick-arrow-icon-color-hover-outer: #000000;
...
@time-picker-menu-item-color-hover: #000000;
...
@nav-primary-bg-color: #3A3C4B;

@nav-primary-border-width: 0;

@nav-primary-border-color: #000000;

@nav-primary-text-color: #FFFFFF;

@nav-primary-text-style: normal;

@nav-primary-shadow: 2px 2px 6px 0px rgba(255, 106, 0, 0.3);

@nav-primary-sub-nav-bg-color: #3A3C4B;
...
@nav-primary-item-hover-bg-color: #2A2C3C;

@nav-primary-item-hover-text-color: #FF6A00;

@nav-primary-sub-nav-hover-bg-color: #3A3C4B;

@nav-primary-sub-nav-hover-text-color: #FFFFFF;

@nav-primary-item-selected-bg-color: #2A2C3C;

@nav-primary-item-selected-text-color: #FF6A00;

@nav-primary-item-selected-text-style: bold;

@nav-primary-item-selected-active-color: #2A2C3C;

@nav-primary-sub-nav-selected-bg-color: #000000;

@nav-primary-sub-nav-selected-text-color: #FFFFFF;

@nav-primary-sub-nav-active-color: #FF6A00;

@nav-primary-item-opened-bg-color: #3A3C4B;

@nav-primary-item-opened-text-color: #FFFFFF;

@nav-secondary-bg-color: #FF6A00;

@nav-secondary-border-width: 0;

@nav-secondary-border-color: #FF6A00;

@nav-secondary-text-color: #FFFFFF;

@nav-secondary-text-style: normal;

@nav-secondary-shadow: 2px 2px 6px 0px rgba(255, 106, 0, 0.3);

@nav-secondary-sub-nav-bg-color: #FF6A00;
...
@nav-secondary-item-hover-bg-color: #E35300;

@nav-secondary-item-hover-text-color: #FFFFFF;

@nav-secondary-sub-nav-hover-bg-color: #E35300;

@nav-secondary-sub-nav-hover-text-color: #FFFFFF;

@nav-secondary-item-selected-bg-color: #E35300;

@nav-secondary-item-selected-text-color: #FFFFFF;

@nav-secondary-item-selected-text-style: bold;

@nav-secondary-item-selected-active-color: #E35300;

@nav-secondary-sub-nav-selected-bg-color: #E35300;

@nav-secondary-sub-nav-selected-text-color: #FFFFFF;

@nav-secondary-sub-nav-active-color: #FF6A00;

@nav-secondary-item-opened-bg-color: #E35300;
...
@nav-normal-text-color: #000000;

@nav-normal-text-style: normal;

@nav-normal-border-line: 1px;

@nav-normal-shadow: 2px 2px 6px 0px rgba(255, 106, 0, 0.3);

@nav-normal-sub-nav-bg-color: #FFFFFF;

@nav-normal-sub-nav-text-color: #000000;
...
@nav-normal-item-hover-text-color: #FF6A00;

@nav-normal-sub-nav-hover-bg-color: #F2F3F7;

@nav-normal-sub-nav-hover-text-color: #FF6A00;

@nav-normal-item-selected-bg-color: #F2F3F7;

@nav-normal-item-selected-text-color: #FF6A00;

@nav-normal-item-selected-text-style: bold;

@nav-normal-item-selected-active-color: #FF6A00;

@nav-normal-sub-nav-selected-bg-color: #F2F3F7;

@nav-normal-sub-nav-selected-text-color: #FF6A00;

@nav-normal-sub-nav-active-color: #FF6A00;

@nav-normal-item-opened-bg-color: #F2F3F7;

@nav-normal-item-opened-text-color: #FF6A00;

@nav-line-bg-color: transparent;

@nav-line-border-color: #DCDEE3;

@nav-line-text-color: #000000;
...
@nav-line-sub-nav-text-color: #000000;

@nav-line-sub-nav-text-style: normal;

@nav-line-item-hover-bg-color: transparent;

@nav-line-item-hover-text-color: #FF6A00;

@nav-line-sub-nav-hover-bg-color: transparent;

@nav-line-sub-nav-hover-text-color: #FF6A00;

@nav-line-item-selected-bg-color: transparent;

@nav-line-item-selected-text-color: #FF6A00;

@nav-line-item-selected-text-style: bold;

@nav-line-item-selected-active-color: #FF6A00;

@nav-line-sub-nav-selected-bg-color: transparent;

@nav-line-sub-nav-selected-text-color: #FF6A00;

@nav-line-sub-nav-active-color: #FF6A00;

@nav-line-item-opened-bg-color: transparent;

@nav-line-item-opened-text-color: #FF6A00;
...
@tab-close-icon-color-hover: #000000;

@tab-close-icon-color-selected: #FF6A00;
...
@tab-nav-arrow-color-hover: #000000;
...
@tab-pure-text-color-hover: #000000;

@tab-pure-text-color-selected: #FF6A00;

@tab-pure-text-color-disabled: #DCDEE3;

@tab-pure-ink-bar-color: #FF6A00;
...
@tab-wrapped-tab-corner-radius: 5px;
...
@tab-wrapped-ink-bar-color: #FF6A00;

@tab-wrapped-nav-item-border-color-active: #FF6A00;
...
@tab-wrapped-text-color-hover: #000000;
...
@tab-wrapped-text-color-selected: #FF6A00;
...
@tab-capsule-text-color: #000000;

@tab-capsule-text-color-hover: #000000;
...
@tab-capsule-bg-color-selected: #FF6A00;

@tab-capsule-bg-color-disabled: #F7F8FA;

@tab-capsule-tab-border-line-color: #C4C6CF;

@tab-capsule-tab-border-line-color-hover: #FF6A00;

@tab-capsule-tab-border-line-color-active: #FF6A00;

@tab-capsule-tab-border-line-color-disabled: #E6E7EB;

@tab-capsule-corner-radius: 5px;
...
@tab-text-text-color-hover: #000000;

@tab-text-text-color-selected: #FF6A00;
...
@calendar-fullscreen-table-head-color: #000000;

@calendar-fullscreen-table-cell-normal-background: #FFFFFF;

@calendar-fullscreen-table-cell-normal-color: #000000;

@calendar-fullscreen-table-cell-normal-border-color: #DCDEE3;

@calendar-fullscreen-table-cell-hover-background: #FFF0E6;

@calendar-fullscreen-table-cell-hover-color: #FF6A00;

@calendar-fullscreen-table-cell-hover-border-color: #FF6A00;

@calendar-fullscreen-table-cell-select-background: #FFF0E6;

@calendar-fullscreen-table-cell-select-color: #FF6A00;

@calendar-fullscreen-table-cell-select-border-color: #FF6A00;

@calendar-fullscreen-table-cell-select-font-weight: bold;

@calendar-fullscreen-table-cell-current-background: #FFFFFF;

@calendar-fullscreen-table-cell-current-color: #FF6A00;

@calendar-fullscreen-table-cell-current-border-color: #FF6A00;
...
@calendar-card-table-cell-date-border-radius: 50%;

@calendar-card-table-cell-month-border-radius: 30px;

@calendar-card-table-cell-year-border-radius: 5px;
...
@calendar-card-table-cell-hover-background: #FFF0E6;

@calendar-card-table-cell-hover-color: #FF6A00;

@calendar-card-table-cell-hover-border-color: #FFF0E6;

@calendar-card-table-cell-select-background: #FF6A00;

@calendar-card-table-cell-select-color: #FFFFFF;

@calendar-card-table-cell-select-border-color: #FF6A00;
...
@calendar-card-table-cell-current-color: #FF6A00;

@calendar-card-table-cell-current-border-color: transparent;

@calendar-card-table-cell-current-font-weight: bold;

@calendar-card-table-cell-inrange-background: #FFF0E6;

@calendar-card-table-cell-inrange-color: #FF6A00;

@calendar-card-table-cell-inrange-border-color: #FFF0E6;
...
@calendar-panel-header-background: #FF6A00;
...
@breadcrumb-text-current-color: #000000;

@breadcrumb-text-current-weight: normal;

@breadcrumb-text-ellipsis-color: #666666;

@breadcrumb-text-keyword-color: #FF6A00;

@breadcrumb-icon-color: #A0A2AD;

@breadcrumb-text-color-hover: #FF6A00;

@breadcrumb-text-current-color-hover: #FF6A00;

@breadcrumb-text-keyword-color-hover: #FF6A00;
